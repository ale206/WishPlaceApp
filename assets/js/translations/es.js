const lang_es = {
    ...
    faqItems: [
        ...
        },
        {
            ...
            a: "Si todavía no tienes una dirección concreta en mente, Wishplace puede ayudarte con sugerencias basadas en IA. La app puede proponerte direcciones o apartamentos potencialmente interesantes, que puedes añadir a tus Wishplaces con un simple toque."
        },
        {
            q: "¿Cómo creo un Wishplace?",
            a: "Abre la app, busca una dirección, un edificio o una calle, selecciona el lugar que te interesa y añádelo a tus Wishplaces. Las preferencias configuradas, como el presupuesto y las características deseadas, se usan para valorar la compatibilidad con las propiedades disponibles."
        },
        {
            q: "¿Las preferencias se aplican a cada dirección por separado?",
            a: "Las preferencias principales se configuran una vez y se aplican a tus Wishplaces. Esto hace que la búsqueda sea más sencilla y permite al sistema comparar tus intereses con propiedades compatibles de forma más coherente."
        },
        {
            q: "¿Por qué cada dirección tiene una caducidad?",
            a: "Cada Wishplace tiene una duración limitada en días para mantener la plataforma actualizada. Así, los intereses antiguos o que ya no son válidos no quedan activos para siempre, y los matches se basan en solicitudes recientes, reales y todavía útiles."
        },
        {
        ...
        },
        {
            ...
            a: "Wishplace puede hacer más directo el contacto entre propietarios y personas interesadas. En algunos casos, encontrar directamente un comprador o un inquilino motivado puede ayudar a reducir o evitar costes de intermediación. Siempre depende de la situación, de las decisiones de las partes y de las normas aplicables en cada país o ciudad."
        },
        {
            q: "¿Wishplace puede hacer que los precios sean más realistas?",
        ...
        },
        {
            ...
            a: "No. Puedes hablar mediante el chat seguro de Wishplace sin compartir enseguida tu número de teléfono, email u otros datos personales de contacto. Tú decides si y cuándo quieres compartir más información."
        },
        {
        ...
        },
        {
            ...
            a: "Elegir dónde vivir no depende solo del inmueble. Los eventos, servicios, transporte, cambios urbanos y noticias locales pueden influir en la calidad de vida, el interés por una ciudad y el valor percibido de una propiedad."
        },
        {
        ...
        },
        {
            ...
            a: "Sí. Aunque la comunidad todavía esté creciendo, puedes empezar a añadir los lugares que te interesan. Esto ayuda a hacer visible la demanda en tu ciudad y puede atraer a propietarios interesados en entender quién busca en ese lugar."
        },
        {
            q: "¿Wishplace sustituye a los portales inmobiliarios tradicionales?",
            a: "Wishplace no es simplemente otro portal de anuncios. Es una forma diferente de hacer emerger la demanda inmobiliaria. Puede usarse junto con los canales tradicionales, pero parte de una lógica distinta: primero las personas indican dónde quieren vivir o encontrar un espacio, y después pueden aparecer oportunidades compatibles."
        }
    ],
    ...
    howBuyerSteps: [
        ...
        },
        {
            ...
            text: "Si no sabes exactamente dónde vivir, la IA de Wishplace puede sugerirte algunas direcciones y apartamentos potencialmente interesantes según tu búsqueda. Puedes revisarlos y añadirlos con un simple toque, sin tener que conocer previamente todos los edificios de la ciudad."
        },
        {
            title: "4. Añade tus Wishplace",
            text: "Cuando encuentres un lugar interesante, añádelo a tu lista de deseos. Puedes guardar diferentes edificios, direcciones o calles, para que los propietarios puedan entender dónde ya existe una demanda real antes de publicar un anuncio tradicional."
        },
        {
        ...
        },
        {
            ...
            text: "Cada dirección añadida tiene una fecha de caducidad expresada en días. Esto ayuda a Wishplace a mantener activos solo intereses recientes y realistas, evitando solicitudes antiguas o que ya no son válidas. Así, los matches son más actualizados, útiles y fiables."
        },
        {
    ...
    howSellerSteps: [
        ...
        },
        {
            ...
            text: "Cuando encuentres un perfil interesante, puedes iniciar una conversación mediante el chat seguro de la app. Así puedes hablar directamente con personas que ya han expresado interés por ese lugar, reduciendo contactos poco relevantes y pérdidas de tiempo."
        },
        {
    ...
    howAIInsightsSteps: [
        {
            title: "1. Parte de tus preferencias",
            text: "La IA puede ayudarte cuando todavía no tienes una dirección concreta en mente. Según la información disponible y el tipo de búsqueda, Wishplace puede sugerir lugares que podrían encajar con lo que estás buscando."
        },
        {
            title: "2. Descubre apartamentos y direcciones sugeridas",
            text: "Recibe sugerencias útiles para explorar posibilidades que quizá no conocías. Esto es especialmente útil si buscas vivienda en una ciudad grande, si no conoces bien todos los edificios o si quieres ampliar tu búsqueda sin perder tiempo."
        },
        {
            title: "3. Añádelos con un simple toque",
            text: "Cuando una sugerencia te interesa, puedes añadirla a tus Wishplace con un simple toque. Así transformas una idea o una posibilidad en un interés concreto y visible para los propietarios compatibles."
        },
        {
            title: "4. Haz que la búsqueda sea más inteligente",
            text: "Cuanto más clara y actualizada sea tu búsqueda, más puede ayudarte Wishplace a encontrar oportunidades relevantes. La IA no sustituye tu decisión: te ayuda a descubrir lugares que quizá quieras valorar."
        }
    ],
    ...
    howLocalInsightsSteps: [
        {
            title: "1. Sigue los lugares que te interesan",
            text: "Cuando añades un Wishplace o una propiedad, Wishplace puede ayudarte a mantenerte informado sobre la ciudad vinculada a ese lugar. Así no miras solo el inmueble, sino también el contexto en el que se encuentra."
        },
        {
            title: "2. Descubre eventos locales",
            text: "Los eventos pueden ayudarte a entender mejor la vida de una ciudad: actividades culturales, iniciativas públicas, oportunidades sociales y movimiento local. Son informaciones útiles para imaginar cómo sería vivir o invertir en un lugar determinado."
        },
        {
            title: "3. Lee noticias y actualizaciones",
            text: "Las noticias locales pueden influir en una decisión inmobiliaria. Nuevos servicios, cambios urbanos, transporte, aperturas, proyectos públicos o tendencias de la ciudad pueden modificar el interés y el valor percibido de un lugar."
        },
        {
            title: "4. Valora mejor antes de decidir",
            text: "Comprar, alquilar o invertir no depende solo del inmueble. Con información local más accesible, puedes entender mejor el contexto y tomar decisiones más conscientes."
        }
    ],
    ...
    howSavingsSteps: [
        {
            title: "1. Contacto más directo",
            text: "Wishplace ayuda a propietarios, compradores e inquilinos a encontrarse partiendo de un interés ya expresado. Si una persona ha indicado precisamente ese edificio o esa dirección, el primer contacto es más enfocado y menos casual."
        },
        {
            title: "2. Posible ahorro en costes",
            text: "Al encontrar personas directamente interesadas, un propietario puede decidir gestionar el primer contacto de forma autónoma. En algunos casos, esto puede ayudar a ambas partes a reducir o evitar gastos de agencia y otros costes innecesarios."
        },
        {
            title: "3. Precios guiados por la demanda real",
            text: "El precio no debería depender solo de quien publica o controla los anuncios en una zona. Con Wishplace, el propietario puede ver qué presupuesto tienen las personas interesadas y entender mejor cuánto está dispuesto a pagar el mercado real por ese lugar."
        },
        {
            title: "4. Más equilibrio entre quien busca y quien ofrece",
            text: "Quien busca vivienda puede indicar su presupuesto y sus preferencias antes de que exista un anuncio. Quien vende o alquila puede usar esta información para valorar un precio más realista, conectado con la capacidad de gasto de las personas."
        },
        {
            title: "5. Menos tiempo perdido",
            text: "Un match basado en dirección, preferencias, presupuesto y caducidad reduce conversaciones poco útiles. Las partes entran en contacto solo cuando existe una compatibilidad más concreta."
        }
    ],
    ...
    howExpirationSteps: [
        {
            title: "1. Cada dirección tiene una caducidad",
            text: "Cuando añades un Wishplace, el interés queda activo durante un periodo definido. Esto ayuda a mostrar a los propietarios solo solicitudes recientes y todavía válidas."
        },
        {
            title: "2. Las propiedades se mantienen actuales",
            text: "Las propiedades añadidas por los propietarios también pueden tener una duración limitada. De esta manera se reduce el riesgo de ver ofertas desactualizadas o que ya no están disponibles."
        },
        {
            title: "3. Matches más precisos",
            text: "La caducidad ayuda a crear mejores matches, porque pone en contacto a personas y propiedades activas durante el mismo periodo. Esto hace que la conversación sea más útil y aumenta la calidad de las oportunidades."
        },
        {
            title: "4. Menos ruido, más calidad",
            text: "Wishplace no busca acumular anuncios antiguos, sino mantener un mercado más dinámico y realista. Menos datos obsoletos significa resultados más claros para todos."
        }
    ],
