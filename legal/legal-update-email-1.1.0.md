...
**Subject:** Important update to Wishplace's legal documents

**Preheader:** Please review our updated Terms, Privacy Policy and Credits Policy.
...
- We clarified account deletion, backups and the limited circumstances in which information may be retained.
- The Terms now explain prohibited content and conduct, how illegal content can be reported, how moderation decisions are made and how affected users can challenge them.
- Professional-user terms now explain the main ranking parameters, data access, changes, restrictions and termination.
...
- [Credits Policy](https://wishplace.app/legal/tokens-enGB.html)
...
**Asunto:** Actualización importante de los documentos legales de Wishplace

**Preencabezado:** Revise los Términos, la Política de Privacidad y la Política de Créditos actualizados.
...
- Hemos aclarado la eliminación de cuentas, las copias de seguridad y los supuestos limitados en que pueden conservarse datos.
- Los Términos explican el contenido y las conductas prohibidos, la denuncia de contenido ilegal, las decisiones de moderación y cómo impugnarlas.
...
- [Términos y Condiciones](https://wishplace.app/legal/terms-esES.html)
- [Política de Privacidad](https://wishplace.app/legal/privacy-esES.html)
- [Política de Créditos](https://wishplace.app/legal/tokens-esES.html)

Gracias por utilizar Wishplace.

---

## Deutsch (de-DE)

**Betreff:** Wichtige Aktualisierung der rechtlichen Dokumente von Wishplace

**Vorschautext:** Bitte prüfen Sie die aktualisierten Bedingungen, die Datenschutzerklärung und die Credits-Richtlinie.
...
- Wir haben Kontolöschung, Backups und die begrenzten Gründe für eine weitere Datenspeicherung klargestellt.
- Die Bedingungen erläutern verbotene Inhalte und Verhaltensweisen, Meldungen rechtswidriger Inhalte, Moderationsentscheidungen und deren Anfechtung.
- Für gewerbliche Nutzer werden die wichtigsten Rankingparameter, Datenzugang, Änderungen, Einschränkungen und Beendigung erläutert.
...
- [Datenschutzerklärung](https://wishplace.app/legal/privacy-deDE.html)
- [Credits-Richtlinie](https://wishplace.app/legal/tokens-deDE.html)

Vielen Dank, dass Sie Wishplace nutzen.

---

## Français (fr-FR)

**Objet :** Mise à jour importante des documents juridiques de Wishplace

**Pré-en-tête :** Consultez nos Conditions, notre Politique de confidentialité et notre Politique de Crédits mises à jour.
...
- Nous avons clarifié la suppression des comptes, les sauvegardes et les cas limités dans lesquels des données peuvent être conservées.
- Les Conditions précisent les contenus et comportements interdits, le signalement de contenus illégaux, les décisions de modération et leur contestation.
...
- [Conditions](https://wishplace.app/legal/terms-frFR.html)
- [Politique de confidentialité](https://wishplace.app/legal/privacy-frFR.html)
- [Politique de Crédits](https://wishplace.app/legal/tokens-frFR.html)

Merci d'utiliser Wishplace.

---

## Italiano (it-IT)

**Oggetto:** Aggiornamento importante dei documenti legali di Wishplace

**Preheader:** Consulta i Termini, l'Informativa privacy e la Politica sui Crediti aggiornati.
...
- Abbiamo chiarito l'eliminazione dell'account, i backup e i casi limitati in cui i dati possono essere conservati.
- I Termini spiegano contenuti e comportamenti vietati, la segnalazione di contenuti illegali, le decisioni di moderazione e come contestarle.
- Le condizioni per utenti professionali spiegano i principali parametri di posizionamento, l'accesso ai dati, le modifiche, le restrizioni e la cessazione.
...
- [Informativa sulla Privacy](https://wishplace.app/legal/privacy-itIT.html)
- [Politica sui Crediti](https://wishplace.app/legal/tokens-itIT.html)

Grazie per usare Wishplace.

---

## Português (pt-PT)

**Assunto:** Atualização importante dos documentos legais da Wishplace

**Pré-cabeçalho:** Consulte os Termos, a Política de Privacidade e a Política de Créditos atualizados.
...
- Clarificámos a eliminação da conta, as cópias de segurança e os casos limitados em que os dados podem ser conservados.
- Os Termos explicam os conteúdos e comportamentos proibidos, a denúncia de conteúdos ilegais, as decisões de moderação e a forma de as contestar.
...
- [Termos e Condições](https://wishplace.app/legal/terms-ptPT.html)
- [Política de Privacidade](https://wishplace.app/legal/privacy-ptPT.html)
- [Política de Créditos](https://wishplace.app/legal/tokens-ptPT.html)

Obrigado por utilizar a Wishplace.
